		...
		<div class="container">
			<div class="row my-4">
				<div class="col-lg footer-copyright my-auto">
					<h5 class="text-dark">Copyright &copy; 2022 Universitas Bina Sarana Informatika</h5>
					<div class="row">
				...
				<div class="col-lg footer-sosial-media pt-2 my-auto">
					<a class="text-decoration-none mx-2 text-dark" target="_blank" href="https://github.com/ferirochmanto"><i class="fab fa-2x fa-github"></i></a>
					<a class="text-decoration-none mx-2 text-dark" target="_blank" href="https://instagram.com/"><i class="fab fa-2x fa-instagram"></i></a>
				</div>
			</div>
		</div>
	</footer>
