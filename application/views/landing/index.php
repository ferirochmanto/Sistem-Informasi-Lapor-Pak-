...
<main class="flex-shrink-0">
	<div class="container pb-5">
		<div class="row justify-content-center py-4">
			<div class="col-lg">
				<h4>Tata Cara Penggunaan Sistem Informasi Lapor Pak!</h4>
					...
					<div class="py-2 col-xl-2 col-lg-3 col-md-3">
						<div class="card">
							<div class="card-body text-center">
								...
								<h4>Daftar</h4>
								<p>Daftarkan diri anda<a href="<?= base_url('landing/daftar'); ?>"> Daftar</a>. Jika sudah mendaftar, silahkan <a href="<?= base_url('landing/masuk'); ?>"> Masuk</a>.</p>
							</div>
						</div>
					</div>
					...
					<div class="py-2 col-xl-2 col-lg-3 col-md-3">
						<div class="card">
							<div class="card-body text-center">
								...
								<h4>Masuk</h4>
								<p>Login menggunakan username dan password anda</p>
							</div>
						</div>
					</div>
					<div class="py-2 col-lg-1 my-auto card-guide">
					...
					<div class="py-2 col-xl-2 col-lg-3 col-md-3">
						<div class="card">
							<div class="card-body text-center">
								...
								<h4>Pengaduan</h4>
								<p>Pada sidebar tekan "Tambah Pengaduan" untuk membuat laporan pengaduan.</p>
							</div>
						</div>
					</div>
					<div class="py-2 col-lg-1 my-auto card-guide">
					...
					<div class="py-2 col-xl-2 col-lg-3 col-md-3">
						<div class="card">
							<div class="card-body text-center">
								...
								<h4>Tanggapan</h4>
								<p>Untuk melihat tanggapan petugas, tekan tombol <button type="button" class="btn btn-xs btn-info"><i class="fas fa-fw fa-reply"></i></button>.</p>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="row py-4" id="tentang">
			<div class="col-lg">
				<h4>Tentang</h4>
				<p>Sistem Informasi Lapor Pak! adalah pengelolaan pengaduan pelayanan publik di Kota Purwokerto, setiap organisasi penyelenggara di Kota Purwokerto belum terkelola secara efektif dan terintegrasi. Masing-masing instansi penyelenggara mengelola pengaduan secara parsial dan tidak terkoordinir dengan baik. Akibatnya terjadi duplikasi penanganan pengaduan, atau bahkan bisa terjadi suatu pengaduan tidak ditangani oleh satupun organisasi penyelenggara, dengan alasan pengaduan bukan kewenangannya. Oleh karena itu, untuk mencapai visi yang baik dan benar dalam penanganan pengaduan masyarakat maka perlu untuk mengintegrasikan sistem pengelolaan pengaduan pelayanan publik yang efektif. Tujuannya, masyarakat memiliki saluran pengaduan yang baik, benar, terorganisir dan terpercaya.</p>
			</div>
		</div>
		...
		<div class="row py-4 justify-content-center" id="saran">
			<div class="col-lg-6 my-2">
				<div class="border p-3 rounded">
					...
					<p>Berikan saran dan masukan terbaik Anda agar Sistem Informasi Lapor Pak! bekerja lebih baik lagi.</p>
			...
			<div class="col-lg-6 my-2">
				<div class="border p-3 rounded">
					<h4>Peta Kota Purwokerto</h4>
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d44119.17142368663!2d109.22800928834364!3d-7.427364404623201!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e655c3136423d1d%3A0x4027a76e352e4a0!2sPurwokerto%2C%20Kabupaten%20Banyumas%2C%20Jawa%20Tengah!5e0!3m2!1sid!2sid!4v1672560146177!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				</div>
			</div>
		</div>
	</div>
